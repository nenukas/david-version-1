...
BOUNDS = {
    "crown_thickness": (8.0, 25.0),      # unchanged (sufficient)
    "pin_boss_width": (10.0, 40.0),      # increased max
    "skirt_length": (30.0, 80.0),        # increased max
    "skirt_thickness": (2.0, 10.0),      # increased max
...
def save_results(best, log, feasible, filename=None):
    ...
    if filename is None:
        ...
        filename = f"piston_opt_am_v2_results_{timestamp}.json"
...
if __name__ == "__main__":
    print("Starting piston generative design with ADDITIVE MANUFACTURING V2...")
