...
# Design variable bounds (mm) – expanded for 11 kRPM higher inertia loads
BOUNDS = {
    "beam_height": (30.0, 120.0),
    "beam_width": (20.0, 100.0),
    "web_thickness": (4.0, 30.0),
    "flange_thickness": (3.0, 25.0),
    "big_end_width": (30.0, 120.0),   # must match crankshaft pin width
    "small_end_width": (20.0, 120.0),
    "small_end_diameter": (30.0, 80.0),  # piston pin diameter
    "fillet_big": (2.0, 20.0),
    "fillet_small": (1.0, 15.0),
}
