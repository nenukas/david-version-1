...
Relaxed thresholds: crown bending stress <0.8×yield (248 MPa),
pin bearing pressure <80 MPa.
Uses RelaxedPistonAnalyzer.
"""
import numpy as np
import random
import json
...
from src.engine.piston_relaxed import RelaxedPistonAnalyzer
...
def save_results(best, log, feasible, filename=None):
    ...
    if filename is None:
        ...
        filename = f"piston_opt_relaxed_results_{timestamp}.json"
...
if __name__ == "__main__":
    print("Starting piston generative design with RELAXED constraints...")
    print(f"Relaxed thresholds: crown stress <0.8×yield (248 MPa), pin bearing pressure <80 MPa")
